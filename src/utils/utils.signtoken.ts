...
const ACCESS_TOKEN_EXPIRY_TIME = 90
...
const signRefreshToken = (email: string, role: string): string => {
  return jwt.sign({ email, role }, REFRESH_SECRET, { expiresIn: REFRESH_TOKEN_EXPIRY_TIME })
}
